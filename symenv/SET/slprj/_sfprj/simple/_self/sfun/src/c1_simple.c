...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2319128578U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4135361440U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2645046705U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2606779208U);
}
...
static void mdlSetWorkWidths_c1_simple(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2763109255U));
  ssSetChecksum1(S,(968689736U));
  ssSetChecksum2(S,(2916346191U));
  ssSetChecksum3(S,(3678119681U));
