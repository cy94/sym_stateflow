...
MACHINE     = four_states_sym
TARGET      = sfun
CHART_SRCS 	= c1_four_states_sym.c
MACHINE_SRC	= four_states_sym_sfun.c
MACHINE_REG = four_states_sym_sfun_registry.c
MAKEFILE    = four_states_sym_sfun.mak
...
OBJLIST_FILE = four_states_sym_sfun.mol
