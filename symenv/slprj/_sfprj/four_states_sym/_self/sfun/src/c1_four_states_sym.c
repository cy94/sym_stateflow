...
static void c1_update(SFc1_four_states_symInstanceStruct *chartInstance)
{
  ...
  int32_T c1_i0;
  static char_T c1_cv0[9] = { 'u', 'p', 'd', 'a', 't', 'e', 'E', 'n', 'v' };
...
static void c1_init(SFc1_four_states_symInstanceStruct *chartInstance)
{
  ...
  real_T c1_nargout = 0.0;
  int32_T c1_i1;
  static char_T c1_cv1[7] = { 'i', 'n', 'i', 't', 'E', 'n', 'v' };
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1356008568U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3892094343U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2306795381U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1169761610U);
}
...
mxArray *sf_c1_four_states_sym_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Yek28i6rPHV7tUbf0gPIRH");
...
static void mdlSetWorkWidths_c1_four_states_sym(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1070544132U));
  ssSetChecksum1(S,(287417579U));
  ssSetChecksum2(S,(4119428785U));
  ssSetChecksum3(S,(3694809484U));
