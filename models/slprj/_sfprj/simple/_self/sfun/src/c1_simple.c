...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static c1_state_name c1_f_emlrt_marshallIn(SFc1_simpleInstanceStruct
  *chartInstance, const mxArray *c1_state, const char_T *c1_identifier);
static c1_state_name c1_g_emlrt_marshallIn(SFc1_simpleInstanceStruct
  ...
  *chartInstance, const mxArray *c1_state, const char_T *c1_identifier)
{
  ...
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_b_y = c1_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_state), &c1_thisId);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3422702422U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2566862693U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4138820U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3556345962U);
}
...
mxArray *sf_c1_simple_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("6rPvbIzF6PRyjhGOoUb6XG");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(4,0,"update",0,-1,80);
...
static void mdlSetWorkWidths_c1_simple(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1258296856U));
  ssSetChecksum1(S,(4116634255U));
  ssSetChecksum2(S,(4056661988U));
  ssSetChecksum3(S,(3589166710U));
